 ...
 * Operator: Query
 * Task number: 1
 * Short description: Create a graph of persons that knows "John Jones". How many persons know him?
 */
public class QueryTutorial_1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    graph.writeTo(new DOTDataSink("gradoop_tutorial_output" + File.separator + "03_query_1.dot", true,
      DOTDataSink.DotFormat.HTML));

    // finally execute
    env.execute("Gradoop Tutorial - Query - Task 1");
  }
}
